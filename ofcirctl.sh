...
case $1 in
    acquire)
        ...
        res=$(curl -s -X POST -H "X-OFCIRTOKEN: $TOKEN" http://localhost:9898/v1/ofcir${type})
        echo $res
        ;;
    ...
    status)
        ...
        res=$(curl -s  -H "X-OFCIRTOKEN: $TOKEN" http://localhost:9898/v1/ofcir/$2)
        echo $res
        ;;
    ...
    release)
        ...
        res=$(curl -s -X DELETE  -H "X-OFCIRTOKEN: $TOKEN" http://localhost:9898/v1/ofcir/$2)
        echo $res
        ;;
